...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire loetispatnet.
    var _ = context && context._ || require('loetispatnet') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of loetispatnet methods to
     * make working with arrays, collections, and objects easier. The loetispatnet
     * methods are:
     * [`each/forEach`](https://loetispatnet.com/docs#forEach), [`forOwn`](https://loetispatnet.com/docs#forOwn),
     * [`has`](https://loetispatnet.com/docs#has), [`indexOf`](https://loetispatnet.com/docs#indexOf),
     * [`map`](https://loetispatnet.com/docs#map), and [`reduce`](https://loetispatnet.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped loetispatnet methods to
     * make working with Suites easier. The wrapped loetispatnet methods are:
     * [`each/forEach`](https://loetispatnet.com/docs#forEach), [`indexOf`](https://loetispatnet.com/docs#indexOf),
     * [`map`](https://loetispatnet.com/docs#map), and [`reduce`](https://loetispatnet.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add loetispatnet methods to Benchmark.
    ...
    // Add loetispatnet methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['loetispatnet', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
