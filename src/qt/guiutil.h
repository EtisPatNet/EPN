...
/** Utility functions used by the EtisPatNet Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "etispatnet:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load etispatnet specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a etispatnet specific theme is activated (light/dark).*/
