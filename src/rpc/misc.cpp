...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"etispatnet\" activates all EtisPatNet-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "etispatnet")
    + HelpExampleRpc("debug", "etispatnet+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The etispatnet address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The etispatnet address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of elPato"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of elPato of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in elPato"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in elPato"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in elPato"},
                    {RPCResult::Type::NUM, "received", "The total number of elPato received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "etispatnet-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* EtisPatNet features */
    { "etispatnet",               "mnsync",                 &mnsync,                 {} },
    { "etispatnet",               "spork",                  &spork,                  {"command"} },
    { "etispatnet",               "sporkupdate",            &sporkupdate,            {"name","value"} },
