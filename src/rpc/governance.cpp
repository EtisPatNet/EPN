...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 EPN irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on etispatnetcentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* EtisPatNet features */
    { "etispatnet",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "etispatnet",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "etispatnet",               "gobject",                &gobject,                {} },
    { "etispatnet",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
