 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1708950982, nBits=1e0ffff0, nNonce=1025281, vtx=1)
...
{
    const char* pszTimestamp = "2024 Banda Lexichei";
    const CScript genesisOutputScript = CScript() << ParseHex("046c8045230c626047f38bb5c6def7526516a3c21b4891d939f085e9cd03d9da6add8621789c33800fe022c7f82a69327df8ec92abe559deadc8d0b2786254aa16") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 1 + 4; // V19 activation height + miner confirmation window
        ...
        consensus.nRuleChangeActivationThreshold = 4; // 95% of 4
        ...
        consensus.defaultAssumeValid = uint256S("0x00000ebd900512cfa2164ff0f7ed18481874eede3310490869d1332fa63d6b4f"); 
        ...
        genesis = CreateGenesisBlock(1708950982, 1025281, 0x1e0ffff0, 1, 120 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000ebd900512cfa2164ff0f7ed18481874eede3310490869d1332fa63d6b4f"));
        assert(genesis.hashMerkleRoot == uint256S("0xe86c9fb6ec227bd273f4f22515847eb49a2e3ce729d5f7337437074d115809c6"));
        ...
        // EtisPatNet BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // EtisPatNet BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // EtisPatNet BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"12khzpVqS6Gu8Pi4QdiJb1oWuLZF84gsW9"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000ebd900512cfa2164ff0f7ed18481874eede3310490869d1332fa63d6b4f")},
            }
        };
        ...
        // getchaintxstats 17280 00000ebd900512cfa2164ff0f7ed18481874eede3310490869d1332fa63d6b4f
        chainTxData = ChainTxData{
                1708950982, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockMaturityWindow = 4;
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000098f6c145559ac5bded60aa451a637710f893e526b971bce0bcf21422cc7"); 
        ...
        genesis = CreateGenesisBlock(1708950987UL, 1524345UL, 0x1e0ffff0, 1, 120 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000098f6c145559ac5bded60aa451a637710f893e526b971bce0bcf21422cc7"));
        assert(genesis.hashMerkleRoot == uint256S("0xe86c9fb6ec227bd273f4f22515847eb49a2e3ce729d5f7337437074d115809c6"));
        ...
        // Testnet EtisPatNet BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet EtisPatNet BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet EtisPatNet BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"EWHqZkeaNChfk2nsb1oWZ7T4jYbz5iBfHJ"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000098f6c145559ac5bded60aa451a637710f893e526b971bce0bcf21422cc7")},
            }
        };
        ...
        // getchaintxstats 17280 0000098f6c145559ac5bded60aa451a637710f893e526b971bce0bcf21422cc7
        chainTxData = ChainTxData{
                1708950987, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1708950992, 3, 0x207fffff, 1, 120 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x647a764672a8428cb79caaa7c17e22789da16b3ec3e17bce7d16082fe7f3ed48"));
        assert(genesis.hashMerkleRoot == uint256S("0xe86c9fb6ec227bd273f4f22515847eb49a2e3ce729d5f7337437074d115809c6"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 120 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x647a764672a8428cb79caaa7c17e22789da16b3ec3e17bce7d16082fe7f3ed48")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 6RVJURoAfTECtTWoZnKXykzjgPfQepMgfYMzngH6z9CyNeLMxS8
        vSporkAddresses = {"EHWaJFnUqWNfhBPEJtozZB6nnth1A8m16s"};
        nMinSporkKeys = 1;
        ...
        // Regtest EtisPatNet addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,33);
        // Regtest EtisPatNet script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,34);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,161);
        // Regtest EtisPatNet BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest EtisPatNet BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest EtisPatNet BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
