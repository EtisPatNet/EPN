...
//! Interface for the src/evo part of a etispatnet node (etispatnetd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a etispatnet node (etispatnetd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a etispatnet node (etispatnetd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a etispatnet node (etispatnetd process).
...
//! Top-level interface for a etispatnet node (etispatnetd process).
class Node
{
public:
    virtual ~Node() {}
