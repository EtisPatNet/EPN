...
/* Initialize EtisPatNet-specific components after chainstate initialization */
void EtisPatNetTestSetup(NodeContext& node);
void EtisPatNetTestSetupClose(NodeContext& node);
