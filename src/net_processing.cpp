 ...
 *  We have 4 times smaller block times in EtisPatNet, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        EtisPatNet Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // EPN this code also handles non-TXs (EtisPatNet specific messages)
