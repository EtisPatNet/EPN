...
"""Verify that starting etispatnetd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start etispatnetd with -h for help text")
        ...
        self.log.info("Start etispatnetd with -version for version information")
        ...
        self.log.info("Start etispatnetdd with -fakearg to make sure it does not start")
