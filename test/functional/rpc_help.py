...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: EtisPatNet's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'EtisPatNet', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
