# Support for Output Descriptors in EtisPatNet Core

Since EtisPatNet Core v0.17, there is support for Output Descriptors. This is a
...
existing EtisPatNet Core wallets, a convenience function `combo` is
...
All RPCs in EtisPatNet Core will include the checksum in their output. Only
