...
This document provides guidelines for internationalization of the EtisPatNet Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `etispatnet_en.ts` remains unchanged.
