EtisPatNet Core version 18.0.2
========================
...
See detailed [set of changes](https://github.com/EtisPatNet/compare/v18.0.1...etispatnetpay:v18.0.2`).

- [`666ff7bff9`](https://github.com/EtisPatNet/commit/666ff7bff9) merge bitcoin#14193: Add missing mempool locks
- [`96f4022a6a`](https://github.com/EtisPatNet/commit/96f4022a6a) chore: archive release-nodes.md
- [`0b60096d8a`](https://github.com/EtisPatNet/commit/0b60096d8a) chore: bump version to 18.0.2
- [`e8afde2740`](https://github.com/EtisPatNet/commit/e8afde2740) fix: Flush chainstate (and evodb) cache whenever evodb mem usage is getting too high (#5007)
- [`8efd7f04c6`](https://github.com/EtisPatNet/commit/8efd7f04c6) Merge bitcoin/bitcoin#25739: Update leveldb subtree (#5005)
- [`c92cbce6a5`](https://github.com/EtisPatNet/commit/c92cbce6a5) trivial: Fix trailing whitespaces in release notes (#4989)
...
- [v18.0.1](https://github.com/EtisPatNet/blob/master/doc/release-notes/etispatnet/release-notes-18.0.1.md) released Aug/17/2022
