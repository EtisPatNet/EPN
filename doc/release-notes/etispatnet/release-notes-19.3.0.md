# EtisPatNet Core version v19.3.0
...
- `wipetxes`: New command for `etispatnet-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/EtisPatNet/compare/v19.2.0...etispatnetpay:v19.3.0).
