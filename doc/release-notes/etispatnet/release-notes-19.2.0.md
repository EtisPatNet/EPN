# EtisPatNet Core version v19.2.0
...
At the first startup EtisPatNet Core will run a migration process which can take
...
incompatible with older versions of EtisPatNet Core, so a db migration path was
...
See detailed [set of changes](https://github.com/EtisPatNet/compare/v19.1.0...etispatnetpay:v19.2.0).
