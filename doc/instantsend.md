...
This mechanism has been integrated into Bitcore-Node-EtisPatNet which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/etispatnetpay/insight-api-etispatnet#web-socket-api](https://github.com/etispatnetpay/insight-api-etispatnet#web-socket-api)
* API: [https://github.com/etispatnetpay/insight-api-etispatnet#instantsend-transactions](https://github.com/etispatnetpay/insight-api-etispatnet#instantsend-transactions)
