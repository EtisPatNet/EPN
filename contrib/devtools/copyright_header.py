...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The EtisPatNet Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a EtisPatNet Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The EtisPatNet Core developers'
...
Arguments:
    <base_directory> - The base directory of EtisPatNet Core source code repository.
"""
...
Arguments:
    <file> - A source file in the EtisPatNet Core repository.
"""
