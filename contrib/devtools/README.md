...
etispatnetpay/etispatnet repository.
...
Setup
---------
Configuring the github-merge tool for the EtisPatNet Core repository is done in the following way:

    git config githubmerge.repository etispatnetpay/etispatnet
...
A script to optimize png files in the etispatnet
...
If there are any errors the return value will be 1 and output like this will be printed:
    ...
    .../64/test_etispatnet: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_etispatnet: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_etispatnet: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_etispatnet: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
