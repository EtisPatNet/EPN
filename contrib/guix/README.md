# Bootstrappable EtisPatNet Core Builds

This directory contains the files necessary to perform bootstrappable EtisPatNet
Core builds.
...
To build EtisPatNet Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      EtisPatNet Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/etispatnet-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/etispatnetpay/guix.sigs).
...
[guix-docker]: https://github.com/EtisPatNet/tree/master/contrib/guix/Dockerfile
